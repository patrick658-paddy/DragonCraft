...
public class TestClass
{
    public void CreateMoves()
    {
        ...
        Moves Flame_Slash = new Moves ("Flame_Slash", (byte)1, (short)400, false, (float)0.2, "Burn", (short)20, (short)0);
        
        Moves Splash = new Moves ("Splash", (byte)2, (short)250, false,(float)0, " ", (short)10, (short)0);
        Moves Water_Pump = new Moves ("Water_Pump", (byte)2, (short)400, false, (float)0, " ", (short)20, (short)0);
